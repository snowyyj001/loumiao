...
func (this *NavigationMesh) RandomPosition() (bool, lmath.Point3F) {
	x, y, time := 0, 0, 0
	for x, y = base.RandI(0, this.GetSizeX()-1), base.RandI(0, this.GetSizeY()-1); this.GetGridFlag(x, y) == 0; x, y = base.RandI(0, this.GetSizeX()-1), base.RandI(0, this.GetSizeY()-1) {
		time++
		if time > 100 {
			return false, lmath.Point3F{}
		}
