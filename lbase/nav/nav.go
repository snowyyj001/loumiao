...
var (
	mStaticMesh      = make(map[string]*DtNavMesh)
...
const NAVMESHSET_MAGIC_RAW = int32('M')<<24 | int32('S')<<16 | int32('E')<<8 | int32('T')
const NAVMESHSET_MAGIC_EXT = int32('M')<<24 | int32('S')<<16 | int32('A')<<8 | int32('T')
const NAVMESHSET_VERSION int32 = 1
const TILECACHESET_MAGIC_RAW = int32('T')<<24 | int32('S')<<16 | int32('E')<<8 | int32('T')
const TILECACHESET_MAGIC_EXT = int32('T')<<24 | int32('S')<<16 | int32('A')<<8 | int32('T')
